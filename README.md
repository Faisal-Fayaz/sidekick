...
[![Tests](https://img.shields.io/badge/tests-450%20passing-brightgreen.svg)](tests/)
...
| 450-test suite incl. prompt-regression evals | ✅ | rare |
...
```bash
uv run --python 3.12 --with ".[test]" pytest tests -q   # 450 passed: unit + regression + Textual pilot, no Ollama needed
```
